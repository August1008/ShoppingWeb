...
namespace ShoppingWeb.Api.DataContext
{
    public class ShoppingWebDataContext : DbContext
    {
        public ShoppingWebDataContext(DbContextOptions<ShoppingWebDataContext> options) : base(options) { }
